...
methods:{
	getList(){
		this.loading = true
		this.axios.post('articles',{limit:this.alist.pagination.rowsPerPage,page:this.alist.pagination.nowpage,status:this.dc.status,col:this.dc.cols,mode:'all',search:this.dc.search,super:this.dc.super}).then(response=>{
