...
<div class="q-pa-md" v-if="show">
  <div class="row">
    <q-card style="width:240px;" class="firstline text-center q-py-md no-shadow">
    ...
    <q-card style="width:300px;" class="firstline text-center q-py-md no-shadow q-ml-md">
      <div class="row items-center q-mb-sm">
        <div class="bg-red-10" style="width:5px;height:15px;margin-right:5px"></div>
        <span class="text-subtitle1">栏目权限</span>
      </div>
      <selectcol class="q-px-md" style="height:448px;overflow-y:auto;" disabled :data="$store.state.system.webcols" :selected="$store.state.user.cols"></selectcol>
    </q-card>
...
export default {
    ...
    headimgs:[
      'http://file.scdjw.net/system/headimg/defaultheadimg.gif',
      'http://file.scdjw.net/system/headimg/1.gif',
      'http://file.scdjw.net/system/headimg/2.gif',
      'http://file.scdjw.net/system/headimg/3.gif',
      'http://file.scdjw.net/system/headimg/4.gif',
      'http://file.scdjw.net/system/headimg/5.gif',
      'http://file.scdjw.net/system/headimg/6.gif',
      'http://file.scdjw.net/system/headimg/7.gif',
      'http://file.scdjw.net/system/headimg/8.gif',
      'http://file.scdjw.net/system/headimg/9.gif',
      'http://file.scdjw.net/system/headimg/10.gif',
      'http://file.scdjw.net/system/headimg/11.gif',
    ]
	}),
	created(){
    this.setData()
  ...
  mounted(){
	...
	methods:{
    setData(){
      this.axios.post('getSelf').then(res=>{
    ...
    reviseUser(arg){
      ...
      this.axios.post('reviseSelf', this.data).then(response=>{
