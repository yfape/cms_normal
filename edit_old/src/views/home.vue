...
export default {
      ...
      nav:[
        ...
        {id:9,title:'首页管理',icon:'home_work',href:'/homemessage',identity:3},
        {id:8,title:'模块管理',icon:'view_quilt',href:'/modmessage',identity:3},
	...
	methods:{
    isArtedit(){
      if(this.$route.name == 'artedit'||this.$route.name == 'topic'){
        this.inarticle = true
    ...
    getSystemInfo(){
      this.axios.post('getSystemInfo').then(response=>{
