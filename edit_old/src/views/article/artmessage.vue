...
export default{
  ...
  methods:{
    ...
    getArticleList(){
      this.loading = true
      this.axios.post('getArticleList',{limit:this.alist.pagination.rowsPerPage,page:this.alist.pagination.nowpage,status:this.dc.status,col:this.dc.cols,mode:'self',search:this.dc.search,super:this.dc.super}).then(response=>{
