...
created(){
	this.initData()
	//<iframe frameborder="0" src="https://v.qq.com/txp/iframe/player.html?vid=z0032udy82e" allowFullScreen="true"></iframe>
},
mounted(){
...
methods:{
	...
	insert(){
		let outcode = '<div style="max-width:90%;"><iframe style="width:400px;height:'+400*this.wh+'px;max-width:90%" iframeborder="0" src="'+this.src+'" allowFullScreen="true"></iframe></div>'
